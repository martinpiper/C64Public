...
..\Animation\DeltaCompression\Release\DeltaCompression.exe -savedictionary $f00 Data\dictionary1.bin -savedictionary $f00 Data\dictionary2.bin -maxframesize 16000 -bitmap -fragment 0 Data\frm*05d.col -fragment $400 Data\frm*05d.scr -fragment $800 Data\frm*05d.spr -fragment $c00 Data\frm*05d.sno -fragment $1c00 Data\frm*05d.chr %START% %STEP% %END% 2 $4000 $7c00 Data\frm*05d.del 32
