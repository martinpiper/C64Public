...
rem DeltaCompression\Release\DeltaCompression.exe ..\Data\frm*05d.sch $400 1 1 28 2 $1000 $1ff8 ..\Data\frm*05d.del
...
DeltaCompression\Release\DeltaCompression.exe -savedictionary $400 Data\dictionary1.bin -savedictionary $400 Data\dictionary2.bin -fragment $0400 Data\frm*05d.scr -fragment $0800 Data\frm*05d.chr 1 6 7654 2 $1000 $1ff8 Data\frm*05d.del
rem del Data\*.del /q
