...
unsigned char sidplay2::MPiReadMemByte(const unsigned short address)
{
	return sidplayer.envReadMemByte(address);
}

void sidplay2::MPiWriteMemByte(const unsigned short address, const unsigned char data)
{
	sidplayer.envWriteMemByte(address,data);
}
