...
..\acme.exe -v4 --lib ../ --lib ../../ --lib ../../../ --msvc asm/main4.a asm/Turrican/DisplayData.a
...
java.exe -Xincgc -Xmx256M -Xms256M -jar ..\..\BDD6502\target\BDD6502-1.0.9-SNAPSHOT-jar-with-dependencies.jar --tags @Demo4 --monochrome --plugin pretty --plugin html:target/cucumber --plugin json:target/report1.json --glue macros --glue TestGlue features
