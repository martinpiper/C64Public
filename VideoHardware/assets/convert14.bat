...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --rgbshift 5 6 5 --newpalettes --palettesize 16 --onlyloadwholepalettes ..\tmp\Demo14ScaledSprites4Clouds.pal %FORCERGB_COMMON_1% --nostacking --outputpalettes ..\tmp\Demo14ScaledSprites4Game0.pal %SPRITES_COMMON_1% --resetforcergb %FORCERGB_COMMON_2% --loadpaletteraw ..\tmp\Demo14TitleChars.pal %SPRITES_COMMON_2% --loadpalettebestfit ..\tmp\Demo14ScaledSprites4Clouds.pal %SPRITES_COMMON_3% %SPRITES_ENEMY_1% %SPRITES_ENEMY_2% %SPRITES_GAME_PALETTE_0% --writepass

java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --rgbshift 5 6 5 --newpalettes --palettesize 16 --onlyloadwholepalettes ..\tmp\Demo14ScaledSprites4Clouds.pal %FORCERGB_COMMON_1% --nostacking --outputpalettes ..\tmp\Demo14ScaledSprites4Game1.pal %SPRITES_COMMON_1% --resetforcergb %FORCERGB_COMMON_2% --loadpaletteraw ..\tmp\Demo14TitleChars.pal %SPRITES_COMMON_2% --loadpalettebestfit ..\tmp\Demo14ScaledSprites4Clouds.pal %SPRITES_COMMON_3% %SPRITES_ENEMY_1% %SPRITES_ENEMY_2% %SPRITES_GAME_PALETTE_1% --writepass

rem Note: No SPRITES_ENEMY_1 and SPRITES_ENEMY_2
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --rgbshift 5 6 5 --newpalettes --palettesize 16 --onlyloadwholepalettes ..\tmp\Demo14ScaledSprites4Clouds.pal %FORCERGB_COMMON_1% --nostacking --outputpalettes ..\tmp\Demo14ScaledSprites4Game2.pal %SPRITES_COMMON_1% --resetforcergb %FORCERGB_COMMON_2% --loadpaletteraw ..\tmp\Demo14TitleChars.pal %SPRITES_COMMON_2% --loadpalettebestfit ..\tmp\Demo14ScaledSprites4Clouds.pal %SPRITES_COMMON_3% %SPRITES_GAME_PALETTE_2% --writepass
...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --rgbshift 5 6 5 --newpalettes --palettesize 16 --onlyloadwholepalettes ..\tmp\Demo14ScaledSprites4Clouds.pal %FORCERGB_COMMON_1% --nostacking --outputpalettes ..\tmp\Demo14ScaledSprites4Game4.pal %SPRITES_COMMON_1% --resetforcergb %FORCERGB_COMMON_2% --loadpaletteraw ..\tmp\Demo14TitleChars.pal %SPRITES_COMMON_2% --loadpalettebestfit ..\tmp\Demo14ScaledSprites4Clouds.pal %SPRITES_COMMON_3% %SPRITES_ENEMY_1% %SPRITES_ENEMY_2% %SPRITES_GAME_PALETTE_4% --writepass
