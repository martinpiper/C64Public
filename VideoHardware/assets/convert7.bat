...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --palettesize 16 --rgbshift 5 6 5 --nostacking --newpalettes --resetforcergb --forcergb 63 72 204 --numbitplanes 4 --image "Demo7/foreground.png" --tilewh 16 16 --imagequantize 16 --nowritepass --palettequantize 5 --outputpalettes ../tmp/Demo7PaletteData1.bin --convertwritepass
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --palettesize 16 --rgbshift 5 6 5 --nostacking --newpalettes --resetforcergb --numbitplanes 4 --image "Demo7/background.png" --tilewh 8 8 --imagequantize 16 --nowritepass --palettequantize 5 --outputpalettes ../tmp/Demo7PaletteData2.bin --convertwritepass
...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --palettesize 16 --rgbshift 5 6 5 --usestacking --newpalettes --resetforcergb --forcergb 63 72 204 --numbitplanes 4 --image "Demo7/73181.png" --tilewh 16 16 %REGIONS% --imagequantize 32 --nowritepass --palettequantize 5 --outputpalettes ../tmp/Demo7PaletteData3.bin --convertwritepass
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --palettesize 16 --rgbshift 5 6 5 --nostacking --newpalettes --resetforcergb --forcergb 255 0 255 --numbitplanes 4 --image "RPG status 1024.png" --tilewh 8 8 --imagequantize 16 --nowritepass --palettequantize 1 --outputpalettes ../tmp/Demo7PaletteData4.bin --convertwritepass
