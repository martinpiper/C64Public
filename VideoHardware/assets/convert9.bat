...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --palettesize 16 --rgbshift 4 4 4 --nostacking --newpalettes --resetforcergb --forcergb 255 0 255 --numbitplanes 4 --image "Demo9/sprites1.png" --tilewh 16 16 --imagequantize 16 --nowritepass --image "Demo9/sprites2.png" --tilewh 32 32 --imagequantize 16 --nowritepass --image "Demo9/chars.png" --tilewh 8 8 --nowritepass --image "Demo9/tiles.png" --tilewh 16 16 --outputpalettes ../tmp/Demo9PaletteData.bin --convertwritepass
