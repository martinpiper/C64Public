...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --splitmaps --palettesize 16 --rgbshift 4 4 4 --chars --newpalettes --loadpalette ../tmp/ShadowBeastPaletteData.bin --numbitplanes 4 --image "ShadowBeast/beast_attract_playfield_1_1024_no_fence.png" --tilewh 8 8 --fitpalettes --nostacking --outputplanes ../tmp/ShadowBeastCharsNoFence_plane --outputscrcol ../tmp/ShadowBeastCharsNoFence_map.bin --convertwritepass

echo Convert chars2
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --splitmaps --palettesize 16 --rgbshift 4 4 4 --chars --newpalettes --loadpalette ../tmp/ShadowBeastPaletteData.bin --numbitplanes 4 --image "ShadowBeast/game foreground.png" --tilewh 8 8 --fitpalettes --nostacking --outputplanes ../tmp/ShadowBeastChars2_plane --outputscrcol ../tmp/ShadowBeastChars2_map.bin --convertwritepass
