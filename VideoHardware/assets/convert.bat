...
java -jar ..\..\..\ImageToBitplane\target\imagetobitplane-1.0-SNAPSHOT-jar-with-dependencies.jar --chars --rgbshift 4 4 4 --newpalettes --palettesize 16 --loadpalette ../tmp/PaletteData.bin --image "RPG status 512.png" --tilewh 8 8 --fitpalettes --outputplanes ../tmp/status_plane --outputscrcol ../tmp/status_map.bin --nostacking --numbitplanes 4 --convertwritepass >>..\tmp\map.log
