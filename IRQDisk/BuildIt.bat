@echo off
del TestIRQDisk.prg
..\acme.exe -v3 --msvc TestIRQDisk.a
...
exit -1
:end
..\ExternalTools\C1541\c1541.exe -attach test.d64 -format test,67 -write TestIRQDisk.prg testirqdisk -write screen1.prg screen1 -write screen2.prg screen2 -write TESTSAVE.PRG testsave
