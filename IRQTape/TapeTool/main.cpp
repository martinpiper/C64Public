...
..\..\acme.exe --lib  ../ --lib ../../  -v3 --msvc Loaders.a && Debug\TapeTool.exe m "Loaders.map" wn "test.tap" ocb1 Loaders.bin otl$c0 otft "..\TestMultiplexor.prg" $101 $4896 otl$c0 c && copy /y Loaders.lbl test.lbl && test.tap
// Without TinyHeader
..\..\acme.exe --lib  ../ --lib ../../  -v3 --msvc Loaders.a && Debug\TapeTool.exe m "Loaders.map" wn "test.tap" ocb1 Loaders.bin otl$c0 otf "..\TestMultiplexor.prg" $ff $101 $4896 $900 otl$c0 c && copy /y Loaders.lbl test.lbl && test.tap
*/
